/**
 * paper-adversarial-review — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `paper-adversarial-review.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("paper-adversarial-review");
