/**
 * map-prior-work — the PAID tier: does this skill's description actually fire?
 *
 ...
 *
 * Costs money; not CI.
 *   node .claude/skills/map-prior-work/map-prior-work.eval.mjs [trials]
 */
import { runSkillTriggerEval } from "../../lib/skill-eval-kit.mjs";

await runSkillTriggerEval("map-prior-work");
