/**
 * map-prior-work — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `map-prior-work.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("map-prior-work");
