/**
 * camera-ready — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `camera-ready.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("camera-ready");
