/**
 * research-ideate — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `research-ideate.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("research-ideate");
