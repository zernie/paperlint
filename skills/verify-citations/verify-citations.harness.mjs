/**
 * verify-citations — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `verify-citations.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("verify-citations");
