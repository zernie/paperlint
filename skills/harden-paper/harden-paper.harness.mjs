/**
 * harden-paper — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `harden-paper.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("harden-paper");
