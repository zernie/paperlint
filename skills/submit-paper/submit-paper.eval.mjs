/**
 * submit-paper — the PAID tier: does this skill's description actually fire?
 *
 ...
 *
 * Costs money; not CI.
 *   node .claude/skills/submit-paper/submit-paper.eval.mjs [trials]
 */
import { runSkillTriggerEval } from "../../lib/skill-eval-kit.mjs";

await runSkillTriggerEval("submit-paper");
