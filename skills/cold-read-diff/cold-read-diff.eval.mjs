/**
 * cold-read-diff — the PAID tier: does this skill's description actually fire?
 *
 ...
 *
 * Costs money; not CI.
 *   node .claude/skills/cold-read-diff/cold-read-diff.eval.mjs [trials]
 */
import { runSkillTriggerEval } from "../../lib/skill-eval-kit.mjs";

await runSkillTriggerEval("cold-read-diff");
