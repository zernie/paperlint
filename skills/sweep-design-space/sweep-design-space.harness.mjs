/**
 * sweep-design-space — the free, deterministic tier. No model, no network.
 *
 ...
 * good result. Those need a real model — see `sweep-design-space.eval.mjs`.
 */
import { checkSkill } from "../../lib/skill-checks.mjs";

await checkSkill("sweep-design-space");
