  ...
  runMutations({
    ...
    cases: [
      ...
      },
      {
        ...
        disables:
          "the exemption — an already-fixed root starts going red, and for an error-level rule a false positive is worse than a miss",
        edits: [
          [
            RULE,
      ...
      },
      {
        ...
        disables:
          "narrowing the predicate — the rule starts demanding a resolve on nested roots too",
        edits: [
          [RULE, "if (!mentionsTmpdir(node.arguments)) return;", "void node;"],
        ],
      },
      {
      ...
      },
      {
        ...
        disables:
          "the guard over the #9 fix itself — on Linux removing the wrapper does not turn a single behavioral test red",
        edits: [
          [
            CORPUS,
