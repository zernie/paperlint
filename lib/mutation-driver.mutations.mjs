  ...
  runMutations({
    ...
    cases: [
      ...
      },
      {
        ...
        disables:
          "the refusal itself — the driver goes back to judging by a harness that never ran",
      ...
      },
      {
        ...
        expect: "a skip must REFUSE",
        disables:
          'recognizing the protocol code — a skip starts reading as "red"',
        edits: [
          [
            DRIVER,
            "const VIGILES_SKIP_EXIT = 77;",
            "const VIGILES_SKIP_EXIT = 76;",
          ],
        ],
      },
    ],
