    ...
    cases: [
      {
        ...
        disables:
          "the observation itself — the version is printed into the void again, and the tier characterizes nothing",
        edits: [
          [
            MOD,
            'spawnSync(program, ["--version"], { encoding: "utf8" })',
            'spawnSync(program, ["--version"], { stdio: "ignore" })',
          ],
        ],
      },
      {
        ...
        disables:
          "the second call-shape assertion: `encoding` is present, but the stream is still killed",
        edits: [
          [
            MOD,
            'spawnSync(program, ["--version"], { encoding: "utf8" })',
            'spawnSync(program, ["--version"], { encoding: "utf8", stdio: "ignore" })',
          ],
        ],
      },
      {
        ...
        disables:
          "rule 4 — `exit 0` with empty output reads as a clean measurement again",
      ...
      },
      {
        ...
        disables:
          "the comparison of observed against characterized — the divergence becomes invisible again",
        edits: [
          [
            MOD,
      ...
      },
      {
        ...
        disables:
          "showing the divergence — the reader is back to having to remember the second number",
        edits: [
          [
            MOD,
            "`observed \\`${program}\\` ${version} — the assertions here were characterized against ` +\n        `${characterized}.",
            "`observed \\`${program}\\` ${version} — characterized elsewhere.",
          ],
        ],
      },
      {
        ...
        disables:
          "parsing the version string — `2.1.273 (Claude Code)` stops being comparable to `2.1.227`",
        edits: [
          [
            MOD,
