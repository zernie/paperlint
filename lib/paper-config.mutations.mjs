  ...
  runMutations({
    ...
    cases: [
      ...
      },
      {
        ...
        // Переименован ПАКЕТ, а не константа: носители остаются согласны между собой, и
        // единственное, что расходится, — связь «ключ = имя пакета». Подмена самой константы
        // убивала бы соседнюю ассерцию про согласие носителей и до этой не доходила.
        edits: [
          [
