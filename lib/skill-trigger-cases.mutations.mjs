...
const MUTATIONS = [
  [
    ...
    [[SRC, "if (declared === undefined && e?.code === \"ERR_MODULE_NOT_FOUND\") return [];", "if (e?.code === \"ERR_MODULE_NOT_FOUND\") return [];"]],
  ...
  [
    ...
    [[SRC, "export const CASES = [...PACKAGE_CASES, ...(await consumerCases())];", "export const CASES = [...PACKAGE_CASES];"]],
