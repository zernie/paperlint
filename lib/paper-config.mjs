 ...
 *   <paper>/paperlint.json         one paper: its venue, its kind, rule overrides for it alone
 *   venues/<venue>.jsonc           one venue: shipped with paperlint, what the venue requires
 *
...
export const PAPER_SETTINGS_KEYS = Object.freeze({
  venue: "the venue profile the paper is judged against — the pdf/ venue rules, paperlint build",
