...
<!-- count:harnesses -->63 harnesses, <!-- count:batteries -->40 batteries.
...
That is the whole instruction. It runs every gate in order — build, lint, the <!-- count:harnesses -->63 harnesses, the
<!-- count:batteries -->40 mutation batteries, the install e2e under npm and pnpm, and a real `pdflatex` build — and ends
